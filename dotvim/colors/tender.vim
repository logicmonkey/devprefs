...
hi IncSearch guifg=#ffffff ctermfg=15 guibg=#000000 ctermbg=0 gui=Bold,reverse cterm=reverse
...
hi Search guifg=#ffffff ctermfg=15 guibg=NONE ctermbg=NONE gui=Bold,reverse cterm=reverse
...
hi verilogLabel guifg=#d3b987 ctermfg=180 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE "Tan
hi verilogRepeat guifg=#f43753 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE "Indianred1
hi systemverilogStatement guifg=#f43753 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE "Indianred1
hi verilogStatement guifg=#73cef4 ctermfg=81 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE "Indianred1
hi verilogOperator guifg=#b3deef ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE "Khaki3

let g:terminal_color_foreground = "#282828"
let g:terminal_color_background = "#eeeeee"
let g:terminal_color_0 = "#282828"
let g:terminal_color_1 = "#f43753" "red1 203 Indianred1
let g:terminal_color_2 = "#c9d05c" "green1 185 Khaki3
let g:terminal_color_3 = "#ffc24b" "yellow2 215 SandyBrown
let g:terminal_color_4 = "#b3deef" "blue1 153 LightSkyBlue1
let g:terminal_color_5 = "#d3b987" "yellow1 180 Tan
let g:terminal_color_6 = "#73cef4" "blue2 81 SteelBlue1
